...
public class EnemyAI : MonoBehaviour
{
   ...
   private void ChasingTarget()
    ...
    {
        return _startingPosition + RemnantsUtils.GetRandomDirection() * UnityEngine.Random.Range(_roamingDistanceMin, _roamingDistanceMax);
    }
