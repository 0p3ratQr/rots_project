...
public class SkeletonVisual : MonoBehaviour
{
    ...
    private const string CHASING_SPEED_MILTIPLIER = "ChasingSpeedMultiplier";
...
public void _enemyEntity_OnDeath(object sender, EventArgs e)
    {
...
private void _enemyEntity_OnTakeHit(object sender, EventArgs e)
    ...
    private void Update()
    {
        ...
        _animator.SetFloat(CHASING_SPEED_MILTIPLIER, _enemyAI.GetRoamingAnimationSpeed());
    }
